package nl.groen.previousDays.day1
...
fun main(args : Array<String>) {
    ...
    var digits = lines.stream().map{
        ...
        twoDigitString[0] = nl.groen.previousDays.day1.extractFistDigit(characters)
        twoDigitString[1] = nl.groen.previousDays.day1.extractLastDigit(characters)
...
private fun extractFistDigit(characters: CharArray): Char {
    for (i in characters.indices) {
        ...
        var digitInWord = nl.groen.previousDays.day1.digitInWord(i, characters.concatToString())
        if (digitInWord != null) {
            return digitInWord
        }
...
private fun extractLastDigit(characters: CharArray): Char {
    for (i in characters.indices) {
        ...
        var digitInWord = nl.groen.previousDays.day1.digitInWordRecursive(characters.size - i, characters.concatToString())
        if (digitInWord != null) {
            return digitInWord
        }
    }
